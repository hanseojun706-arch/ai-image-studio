...
def create_local_premium_code():
    raw = secrets.token_hex(8).upper()
    code = f"AIS-{raw[:4]}-{raw[4:8]}-{raw[8:12]}"
    return code
# =========================================================
# PAGE CONFIG
# =========================================================
...
if st.button("Generate Premium Code"):
    new_code = create_local_premium_code()
    st.success(f"Your code: {new_code}")
# =========================================================
